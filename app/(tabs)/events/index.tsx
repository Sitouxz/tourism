...
export default function EventsScreen() {
  ...
  const allItems = data.event || [];
  const items = getFilteredData('event' as Category);
    ...
    return (
      <View style={[styles.container, { backgroundColor: colors.background }]}>
        ...
        <View style={styles.header}>
          <SectionTitle title="Events" subtitle="Discover exciting events" />
          <SearchBar
            value={searchQuery}
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={styles.header}>
        <SectionTitle 
          title="Events" 
          subtitle="Discover exciting events"
        />
        <SearchBar
          value={searchQuery}
          onChangeText={setSearchQuery}
